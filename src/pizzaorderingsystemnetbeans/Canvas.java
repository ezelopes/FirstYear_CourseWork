...
public class Canvas
{
     ...
     * foreground colour of the canvas.
     * @param  xPos  The x-coordinate of the circle centre point
     * @param  yPos  The y-coordinate of the circle centre point
     ...
     * foreground colour of the canvas. This is a convenience method. A similar 
    ...
    /**
     * Fill the internal dimensions of the given triangle with the current colour
    ...
    /**
     * Fill the internal dimensions of the given polygon with the current colour
    ...
    /**
     * Erase a given shapes interior on the screen.
    ...
    /**
     * Erases a given shapes outline on the screen.
     * @param  shape  the shape object to be erased 
     */
     ...
     * @param  newColor   the new colour for the background of the Canvas 
     */
